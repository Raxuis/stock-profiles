  ...
  return (
    <Section>
      <motion.div initial={{
        ...
        x: 0
      }} className="flex min-h-screen shrink-0 scale-[0.9] flex-col items-center justify-start py-16 text-center [perspective:800px] sm:scale-100 sm:py-32 space-y-6"
      >
        <div>
